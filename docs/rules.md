...
Doxygen/JSDoc/Javadoc-tagged docs (`@brief`, `\param`, `@returns`…), rustdoc
conventional sections (`# Examples`, `# Errors`, `# Panics`, `# Safety`),
Google-style docstring sections (`Args:`, `Returns:`, `Raises:`), Swift doc
callouts (`- Parameter:`, `- Returns:`, `- Throws:`), and C# XML doc tags
(`<summary>`, `<param>`) mark structured API documentation; the docs-migration hint leaves them alone, and
...
- **Java/Kotlin**: `CHECKSTYLE:OFF/ON`, `@formatter:off/on`,
  `spotless:off/on`, `noinspection`, Eclipse `$NON-NLS-n$`; Kotlin adds
  `ktlint-disable/enable`.
- **C#**: `ReSharper disable/restore`, `<auto-generated>` headers (which
  also skip the whole file as generated code).
- **Swift**: `swiftlint:disable/enable`, `swiftformat:`, `sourcery:`,
  `periphery:ignore`, and `MARK:` sections (the `#region` of Xcode).
